...
from human_aware_rl.ppo.ppo_rllib import RllibLSTMPPOModel

# new models and state space definition
from src.models import RllibPPOModelInterpretable
from src.rllib_new import OvercookedMultiAgentInterpretable, gen_trainer_from_params
...
def _env_creator(env_config):
    ...
    from src.rllib_new import OvercookedMultiAgentInterpretable

    return OvercookedMultiAgentInterpretable.from_config(env_config)
...
def my_config():
    ...
    bc_schedule = OvercookedMultiAgentInterpretable.self_play_bc_schedule
    ...
    evaluation_params = {
        ...
        "ACTION_DESCRIPTION_EMBEDDING_NAME": ACTION_DESCRIPTION_EMBEDDING_NAME
    }
    ...
    environment_params = {
        ...
        # To be passed into OvercookedMultiAgentInterpretable constructor
        "multi_agent_params": {
    ...
    ray_params = {
        ...
        else RllibPPOModelInterpretable,
        "temp_dir": temp_dir,
